...
const result = updateCarModel(car, "2 wheel");
console.log(result);
...
// let sum = 5 + 5; // Uttryck (Expression - Datorn räknar ihop resultatet och tilldelas en variabel)

// const handikap2 = age >= 18 ? 10 : 20;

// console.log("Handikap2: ", handikap2);
